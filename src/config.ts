...
export const DEFAULT_CONSOLE_SERVER =
    import.meta.env.VITE_RHYDB_DEFAULT_SERVER || 'https://gs-staging-1.int.genspectrum.org/open/v2/silo';

// Exercises always use this build-time target. It is never editable in the UI.
export const EXERCISE_SERVER =
    import.meta.env.VITE_RHYDB_EXERCISE_SERVER || 'https://gs-staging-1.int.genspectrum.org/open/v2/silo';
...
export const RHYDB_WASM_ENABLED = import.meta.env.VITE_RHYDB_WASM_ENABLED === 'true';
